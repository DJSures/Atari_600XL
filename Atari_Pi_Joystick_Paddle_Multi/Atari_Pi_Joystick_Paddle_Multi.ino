...
byte _lastBSTART = 0;  // 0 button released, 1 button pressed
byte _lastBSELECT = 0; // 0 button released, 1 button pressed
byte _lastBOPTION = 0; // 0 button released, 1 button pressed
byte _lastBRESET = 0;  // 0 button released, 1 button pressed
